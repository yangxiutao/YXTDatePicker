...
@optional
- (void)datePicker:(YXTDatePicker *)datePicker dateDidChange:(NSDate *)date;
- (void)datePicker:(YXTDatePicker *)datePicker didCancel:(UIButton *)sender;
- (void)datePicker:(YXTDatePicker *)dataPicker didSelectedDate:(NSDate *)date;
@end

@interface YXTDatePicker : UIControl
